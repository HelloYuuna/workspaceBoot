...
public class PageNavigator {
     ...
     * 생성자
     */
    public PageNavigator(int pagePerGroup, int countPerPage
...
//        startPageGroup = Math.max(startPageGroup, 1);
...
//        endPageGroup = endPageGroup < totalPageCount ? endPageGroup : totalPageCount;
        endPageGroup = Math.min(endPageGroup, totalPageCount);
